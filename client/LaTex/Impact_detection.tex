...
\lstinputlisting[firstline = 148, lastline = 164, firstnumber =148, style=customc, caption=m\_impact struct defined in $drv\_motion.c$, label=cd:m_impact]
...
\lstinputlisting[linerange={1265-1277}, firstnumber =1265, style=customc, caption=data sampling example in $drv\_motion.c$, label=cd:read_gyro]
{../../source/drivers/drv_motion.c}
...
\lstinputlisting[linerange={1293-1308}, firstnumber =1293, style=customc, caption=data enqueueing example in $drv\_motion.c$, label=cd:data_enqueue]
{../../source/drivers/drv_motion.c}
...
\lstinputlisting[linerange={1336-1346}, firstnumber =1336, style=customc, caption=data dequeueing example in $drv\_motion.c$, label=cd:data_dequeue]{../../source/drivers/drv_motion.c}

\lstinputlisting[linerange={482-529}, firstnumber =482, style=customc, caption=application structure in $drv\_motion.c$, label=cd:impact_main]
{../../source/drivers/drv_motion.c}
